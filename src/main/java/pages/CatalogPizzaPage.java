...
public class CatalogPizzaPage {
    ...
    public final By PIZZA_MARGARITA_LOCATOR = By.xpath("//div[@data-item-id='576']");
    public final By BUTTON_CHOOSE_PIZZA_MARGARITA_LOCATOR = By.xpath("//button[@data-id='364']");
    public final By CATALOG_NAME_PIZZA_MARGARITA_LOCATOR = By.xpath("//div[contains(text(),'Пицца Маргарита')]");
    public  final By CATALOG_PRICE_PIZZA_MARGARITA_LOCATOR = By.xpath("//span[@class='price-val price-val-id-364']");
    public  final By PIZZA_PANEL_USER_ORDER_LOCATOR = By.xpath("//div[@class='basket__products-item-info-wrap']");
    public  final By PIZZA_NAME_PANEL_USER_ORDER_LOCATOR = By.xpath("//div[contains(text(), 'Пицца Маргарита')][last()] ");
    public final By PIZZA_PRICE_PANEL_USER_ORDER_LOCATOR = By.xpath("//div[contains(@class,'basket__sum') ]/span");
    public final By MARGARITA_PRICE_PANEL_USER_ORDER_LOCATOR = By.xpath("//span[@class='main-prod-price']");
    public final By PANEL_USER_ORDER_LOCATOR = By.xpath("//div[@class='basket__btn-top basket__top basket__btn-top--sm']");
